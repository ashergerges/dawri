...
/// Signed-in participant id — needed by the videos "see all" route.
 int? get userId; String get phone; String get avatarPath; bool get isLocalAvatar; XFile? get avatarFile;/// Participant type — decides which list the role dropdown shows.
 ...
 String? get nameError; String? get emailError; String? get birthDateError; String? get cityError; String? get dynamicError; String? get bioError; String? get avatarError; bool get isPickingAvatar; bool get isUpdating; bool get isSuccess;// ─── Reels ───────────────────────────────────────────────
 List<PartnerVideoModel> get videos; UpdateProfileStatus get addVideoStatus;/// Deletions in flight, by video id.
 Set<int> get deletingVideoIds;// ─── Account deactivation ────────────────────────────────
 UpdateProfileStatus get deactivateStatus;
...
@useResult
$Res call({
 String name, String email, String birthDate, String bio, int? cityId, int? dynamicId, int? userId, String phone, String avatarPath, bool isLocalAvatar, XFile? avatarFile, int? typeId, int? sportId, List<CityModel> cities, List<PlayerPositionModel> positions, List<RefereeRoleModel> refereeRoles, List<CoachSpecializationModel> coachSpecs, UpdateProfileStatus loadStatus, UpdateProfileStatus dynamicStatus, String? nameError, String? emailError, String? birthDateError, String? cityError, String? dynamicError, String? bioError, String? avatarError, bool isPickingAvatar, bool isUpdating, bool isSuccess, List<PartnerVideoModel> videos, UpdateProfileStatus addVideoStatus, Set<int> deletingVideoIds, UpdateProfileStatus deactivateStatus
});


$UpdateProfileStatusCopyWith<$Res> get loadStatus;$UpdateProfileStatusCopyWith<$Res> get dynamicStatus;$UpdateProfileStatusCopyWith<$Res> get addVideoStatus;$UpdateProfileStatusCopyWith<$Res> get deactivateStatus;
...
/// Create a copy of UpdateProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? email = null,Object? birthDate = null,Object? bio = null,Object? cityId = freezed,Object? dynamicId = freezed,Object? userId = freezed,Object? phone = null,Object? avatarPath = null,Object? isLocalAvatar = null,Object? avatarFile = freezed,Object? typeId = freezed,Object? sportId = freezed,Object? cities = null,Object? positions = null,Object? refereeRoles = null,Object? coachSpecs = null,Object? loadStatus = null,Object? dynamicStatus = null,Object? nameError = freezed,Object? emailError = freezed,Object? birthDateError = freezed,Object? cityError = freezed,Object? dynamicError = freezed,Object? bioError = freezed,Object? avatarError = freezed,Object? isPickingAvatar = null,Object? isUpdating = null,Object? isSuccess = null,Object? videos = null,Object? addVideoStatus = null,Object? deletingVideoIds = null,Object? deactivateStatus = null,}) {
...
as List<PartnerVideoModel>,addVideoStatus: null == addVideoStatus ? _self.addVideoStatus : addVideoStatus // ignore: cast_nullable_to_non_nullable
as UpdateProfileStatus,deletingVideoIds: null == deletingVideoIds ? _self.deletingVideoIds : deletingVideoIds // ignore: cast_nullable_to_non_nullable
as Set<int>,deactivateStatus: null == deactivateStatus ? _self.deactivateStatus : deactivateStatus // ignore: cast_nullable_to_non_nullable
as UpdateProfileStatus,
  ));
}
/// Create a copy of UpdateProfileState
/// with the given fields replaced by the non-null parameter values.
...
@override
@pragma('vm:prefer-inline')
$UpdateProfileStatusCopyWith<$Res> get addVideoStatus {
  
  return $UpdateProfileStatusCopyWith<$Res>(_self.addVideoStatus, (value) {
    return _then(_self.copyWith(addVideoStatus: value));
  });
}/// Create a copy of UpdateProfileState
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$UpdateProfileStatusCopyWith<$Res> get deactivateStatus {
  
  return $UpdateProfileStatusCopyWith<$Res>(_self.deactivateStatus, (value) {
    return _then(_self.copyWith(deactivateStatus: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String email,  String birthDate,  String bio,  int? cityId,  int? dynamicId,  int? userId,  String phone,  String avatarPath,  bool isLocalAvatar,  XFile? avatarFile,  int? typeId,  int? sportId,  List<CityModel> cities,  List<PlayerPositionModel> positions,  List<RefereeRoleModel> refereeRoles,  List<CoachSpecializationModel> coachSpecs,  UpdateProfileStatus loadStatus,  UpdateProfileStatus dynamicStatus,  String? nameError,  String? emailError,  String? birthDateError,  String? cityError,  String? dynamicError,  String? bioError,  String? avatarError,  bool isPickingAvatar,  bool isUpdating,  bool isSuccess,  List<PartnerVideoModel> videos,  UpdateProfileStatus addVideoStatus,  Set<int> deletingVideoIds,  UpdateProfileStatus deactivateStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateProfileState() when $default != null:
return $default(_that.name,_that.email,_that.birthDate,_that.bio,_that.cityId,_that.dynamicId,_that.userId,_that.phone,_that.avatarPath,_that.isLocalAvatar,_that.avatarFile,_that.typeId,_that.sportId,_that.cities,_that.positions,_that.refereeRoles,_that.coachSpecs,_that.loadStatus,_that.dynamicStatus,_that.nameError,_that.emailError,_that.birthDateError,_that.cityError,_that.dynamicError,_that.bioError,_that.avatarError,_that.isPickingAvatar,_that.isUpdating,_that.isSuccess,_that.videos,_that.addVideoStatus,_that.deletingVideoIds,_that.deactivateStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String email,  String birthDate,  String bio,  int? cityId,  int? dynamicId,  int? userId,  String phone,  String avatarPath,  bool isLocalAvatar,  XFile? avatarFile,  int? typeId,  int? sportId,  List<CityModel> cities,  List<PlayerPositionModel> positions,  List<RefereeRoleModel> refereeRoles,  List<CoachSpecializationModel> coachSpecs,  UpdateProfileStatus loadStatus,  UpdateProfileStatus dynamicStatus,  String? nameError,  String? emailError,  String? birthDateError,  String? cityError,  String? dynamicError,  String? bioError,  String? avatarError,  bool isPickingAvatar,  bool isUpdating,  bool isSuccess,  List<PartnerVideoModel> videos,  UpdateProfileStatus addVideoStatus,  Set<int> deletingVideoIds,  UpdateProfileStatus deactivateStatus)  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileState():
return $default(_that.name,_that.email,_that.birthDate,_that.bio,_that.cityId,_that.dynamicId,_that.userId,_that.phone,_that.avatarPath,_that.isLocalAvatar,_that.avatarFile,_that.typeId,_that.sportId,_that.cities,_that.positions,_that.refereeRoles,_that.coachSpecs,_that.loadStatus,_that.dynamicStatus,_that.nameError,_that.emailError,_that.birthDateError,_that.cityError,_that.dynamicError,_that.bioError,_that.avatarError,_that.isPickingAvatar,_that.isUpdating,_that.isSuccess,_that.videos,_that.addVideoStatus,_that.deletingVideoIds,_that.deactivateStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String email,  String birthDate,  String bio,  int? cityId,  int? dynamicId,  int? userId,  String phone,  String avatarPath,  bool isLocalAvatar,  XFile? avatarFile,  int? typeId,  int? sportId,  List<CityModel> cities,  List<PlayerPositionModel> positions,  List<RefereeRoleModel> refereeRoles,  List<CoachSpecializationModel> coachSpecs,  UpdateProfileStatus loadStatus,  UpdateProfileStatus dynamicStatus,  String? nameError,  String? emailError,  String? birthDateError,  String? cityError,  String? dynamicError,  String? bioError,  String? avatarError,  bool isPickingAvatar,  bool isUpdating,  bool isSuccess,  List<PartnerVideoModel> videos,  UpdateProfileStatus addVideoStatus,  Set<int> deletingVideoIds,  UpdateProfileStatus deactivateStatus)?  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileState() when $default != null:
return $default(_that.name,_that.email,_that.birthDate,_that.bio,_that.cityId,_that.dynamicId,_that.userId,_that.phone,_that.avatarPath,_that.isLocalAvatar,_that.avatarFile,_that.typeId,_that.sportId,_that.cities,_that.positions,_that.refereeRoles,_that.coachSpecs,_that.loadStatus,_that.dynamicStatus,_that.nameError,_that.emailError,_that.birthDateError,_that.cityError,_that.dynamicError,_that.bioError,_that.avatarError,_that.isPickingAvatar,_that.isUpdating,_that.isSuccess,_that.videos,_that.addVideoStatus,_that.deletingVideoIds,_that.deactivateStatus);case _:
  return null;
...
class _UpdateProfileState extends UpdateProfileState {
  const _UpdateProfileState({this.name = '', this.email = '', this.birthDate = '', this.bio = '', this.cityId, this.dynamicId, this.userId, this.phone = '', this.avatarPath = '', this.isLocalAvatar = false, this.avatarFile, this.typeId, this.sportId, final  List<CityModel> cities = const [], final  List<PlayerPositionModel> positions = const [], final  List<RefereeRoleModel> refereeRoles = const [], final  List<CoachSpecializationModel> coachSpecs = const [], this.loadStatus = const UpdateProfileStatus.initial(), this.dynamicStatus = const UpdateProfileStatus.initial(), this.nameError, this.emailError, this.birthDateError, this.cityError, this.dynamicError, this.bioError, this.avatarError, this.isPickingAvatar = false, this.isUpdating = false, this.isSuccess = false, final  List<PartnerVideoModel> videos = const [], this.addVideoStatus = const UpdateProfileStatus.initial(), final  Set<int> deletingVideoIds = const <int>{}, this.deactivateStatus = const UpdateProfileStatus.initial()}): _cities = cities,_positions = positions,_refereeRoles = refereeRoles,_coachSpecs = coachSpecs,_videos = videos,_deletingVideoIds = deletingVideoIds,super._();
...
@override@JsonKey() final  UpdateProfileStatus addVideoStatus;
/// Deletions in flight, by video id.
 final  Set<int> _deletingVideoIds;
/// Deletions in flight, by video id.
@override@JsonKey() Set<int> get deletingVideoIds {
  if (_deletingVideoIds is EqualUnmodifiableSetView) return _deletingVideoIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_deletingVideoIds);
}

// ─── Account deactivation ────────────────────────────────
@override@JsonKey() final  UpdateProfileStatus deactivateStatus;
...
@override $UpdateProfileStatusCopyWith<$Res> get loadStatus;@override $UpdateProfileStatusCopyWith<$Res> get dynamicStatus;@override $UpdateProfileStatusCopyWith<$Res> get addVideoStatus;@override $UpdateProfileStatusCopyWith<$Res> get deactivateStatus;
...
as List<PartnerVideoModel>,addVideoStatus: null == addVideoStatus ? _self.addVideoStatus : addVideoStatus // ignore: cast_nullable_to_non_nullable
as UpdateProfileStatus,deletingVideoIds: null == deletingVideoIds ? _self._deletingVideoIds : deletingVideoIds // ignore: cast_nullable_to_non_nullable
as Set<int>,deactivateStatus: null == deactivateStatus ? _self.deactivateStatus : deactivateStatus // ignore: cast_nullable_to_non_nullable
as UpdateProfileStatus,
  ));
}
